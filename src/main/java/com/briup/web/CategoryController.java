...
public class CategoryController {
	...
	public Message<String> saveOrUpdate(/*@RequestParam(required = false)Integer id, 
	String name,int code*/Category category){	
		//能否拿到参数id  与id的类型无关，主要是参数名称是否与swagger页面里的名称一样。
		//此处的id在service层里与null做比较了，只有Integer类型可以比较
		//原来的有参构造器Category(long code, String name){...}
		//而新建的category类多id参数，所有在dao层要新建一个有 id的Category(Integer id, int code, String name){...}d的有参构造器
